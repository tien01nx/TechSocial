...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (buttonElement) {
        ...
        console.log("ID của người dùng là:", userId);
        ...
        buttonElement.addEventListener('click', function () {
            ...
            xhr.open("GET", '/User/LoadMorePosts?Id=' + userId + '&offset=' + postCount, true);
            xhr.onload = function () {
                        ...
                        let postHTML = `
                          <div class="box shadow-sm border rounded bg-white mb-3 osahan-post">
                              ...
                              <div class="p-3 border-bottom osahan-post-body">
                                <p class="description-limit">${contentPreview}</p>
                                <a href="/Home/Details/${post.postId}">Xem thêm</a>
                              </div>
                              <div class="p-3 border-bottom osahan-post-footer">
                                  <a href="/Home/Details/${post.postId}" class="mr-3 text-secondary">
                                    <i class="fa fa-eye" aria-hidden="true"></i>  ${post.postsView !== null ? post.postsView : 0}
                                  </a>
                                  <a href="/Home/Details/${post.postId}" class="mr-3 text-secondary"><i class="fa fa-comment-o" aria-hidden="true"></i>  8</a>
                              </div>
                          </div>`;
                        document.querySelector('#postsContainer').insertAdjacentHTML('beforeend', postHTML);
                    });
                } else {
                    console.error(xhr);
                }
...
//                        </div>
//                        <div class="p-3 border-bottom osahan-post-footer">
//                                <a href="/Home/Details/${post.postId}" class="mr-3 text-secondary"><i class="fa fa-eye" aria-hidden="true"></i>  ${post.postsView !== null ? post.postsView : 0}</a>
//                                <a href="/Home/Details/${post.postId}" class="mr-3 text-secondary"><i class="fa fa-comment-o" aria-hidden="true"></i>  8</a>
